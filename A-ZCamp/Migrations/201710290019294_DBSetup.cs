    ...
    public partial class DBSetup : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        SurveyMCResponseId = c.Int(nullable: false, identity: true),
                        SurveyQuestionId = c.Int(nullable: false),
                        SurveyRespondentId = c.Int(nullable: false),
                        Choice = c.String(),
                    })
                .PrimaryKey(t => t.SurveyMCResponseId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        SurveyRespondentId = c.Int(nullable: false, identity: true),
                        SurveyTypeId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.SurveyRespondentId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        SurveyRankingResponseId = c.Int(nullable: false, identity: true),
                        SurveyQuestionId = c.Int(nullable: false),
                        SurveyRespondentId = c.Int(nullable: false),
                        Choice = c.String(),
                        Rank = c.String(),
                    })
                .PrimaryKey(t => t.SurveyRankingResponseId)
                .ForeignKey("dbo.SurveyQuestions", t => t.SurveyQuestionId, cascadeDelete: true)
                .ForeignKey("dbo.SurveyRespondents", t => t.SurveyRespondentId, cascadeDelete: true)
                .Index(t => t.SurveyQuestionId)
                .Index(t => t.SurveyRespondentId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        SurveyShortAnswerResponseId = c.Int(nullable: false, identity: true),
                        SurveyQuestionId = c.Int(nullable: false),
                        SurveyRespondentId = c.Int(nullable: false),
                        Answer = c.String(),
                    })
                .PrimaryKey(t => t.SurveyShortAnswerResponseId)
                .ForeignKey("dbo.SurveyQuestions", t => t.SurveyQuestionId, cascadeDelete: true)
                .ForeignKey("dbo.SurveyRespondents", t => t.SurveyRespondentId, cascadeDelete: true)
                .Index(t => t.SurveyQuestionId)
                .Index(t => t.SurveyRespondentId);
